<x-app-layout>
    <x-slot name="header"> Manajemen Rekomendasi </x-slot>
                                    ...
                                    <div class="flex flex-col items-center space-y-2">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span>Perbaiki Pengajuan</span> <button @click="openEdit = false"><svg
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span>Setujui & Beri Kode</span> <button
                                                    @click="openApprove = false"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span>Catatan Koreksi</span> <button @click="openCorrect = false"><svg
                                                        xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="3" d="M6 18L18 6M6 6l12 12" />
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span>Tolak Pengajuan</span> <button @click="openReject = false"><svg
                                                        xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="3" d="M6 18L18 6M6 6l12 12" />
